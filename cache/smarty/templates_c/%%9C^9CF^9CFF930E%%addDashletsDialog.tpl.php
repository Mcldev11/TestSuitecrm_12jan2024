<?php /* Smarty version 2.6.33, created on 2023-09-12 15:55:11
...
<div id="chartDashlets" style="<?php if ($this->_tpl_vars['moduleName'] == 'Home'): ?>height:400px;display:none;<?php else: ?>height:425px;display:;<?php endif; ?>">
	...
	<table width="100%">
		<?php $_from = $this->_tpl_vars['charts']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
<div id="toolsDashlets" style="height:400px;display:none;">
	...
	<table width="95%">
		...
		<?php $_from = $this->_tpl_vars['tools']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
