...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OPPORTUNITIES_ACCOUNTS_1_FROM_OPPORTUNITIES_TITLE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.opportunities_accounts_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.opportunities_accounts_1_name.name}" size="" value="{$fields.opportunities_accounts_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.opportunities_accounts_1_name.id_name}" 
id="{$fields.opportunities_accounts_1_name.id_name}" 
value="{$fields.opportunities_accounts_1opportunities_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.opportunities_accounts_1_name.name}" id="btn_{$fields.opportunities_accounts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.opportunities_accounts_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"opportunities_accounts_1opportunities_ida","name":"opportunities_accounts_1_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.opportunities_accounts_1_name.name}" id="btn_clr_{$fields.opportunities_accounts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.opportunities_accounts_1_name.name}', '{$fields.opportunities_accounts_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.opportunities_accounts_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'opportunities_accounts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_ACCOUNTS_1_FROM_OPPORTUNITIES_TITLE' module='Accounts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'opportunities_accounts_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_OPPORTUNITIES_ACCOUNTS_1_FROM_OPPORTUNITIES_TITLE' module='Accounts' for_js=true}{literal}', 'opportunities_accounts_1opportunities_ida' );
